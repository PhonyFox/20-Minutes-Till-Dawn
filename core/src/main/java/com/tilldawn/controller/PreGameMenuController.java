...
//    DASHER(2, 10, null),;
    ...
    public void selectWeapon(String weaponName) {
        ...
        switch (weaponName.toLowerCase().trim()) {
            case "shotgun": weapon = new Shotgun(2, 300, 1000, user); break;
            case "smgs dual": weapon = new SMGsDual(24, 80, 2000, user); break;
            case "revolver": weapon = new Revolver(6, 200, 1000, user); break;
